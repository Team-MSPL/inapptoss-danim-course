...
const TimePickerModal = forwardRef(
  ({ visible, minuteDivide, hour, minute }, ref) => {
        ...
        <View style={styles.pickerContainer}>
          ...
          <FlatList
            ...
            renderItem={({ item, index }) =>
              renderPickerItem(item, index, index === ampmIndex)
            }
          />
          {/* Hour */}
          <FlatList
            ...
            renderItem={({ item, index }) =>
              renderPickerItem(item, index, index === hourIndex)
            }
          />
          {/* Minute */}
          <FlatList
            ...
            renderItem={({ item, index }) =>
              renderPickerItem(item, index, index === minuteIndex)
            }
          />
        </View>
      </>
