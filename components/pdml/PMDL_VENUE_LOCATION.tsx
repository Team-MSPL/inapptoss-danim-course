...
/**
 * PMDL_VENUE_LOCATION (updated)
 * - uses buildImageUrl for photos
 */
export default function PMDL_VENUE_LOCATION({ moduleKey, moduleData }: { moduleKey: string; moduleData: any }) {
